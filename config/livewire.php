...
return [
    ...
    */
    ...
    'payload' => [
        ...
        'max_nesting_depth' => 30,   // Maximum depth of dot-notation property paths — verhoogd t.o.v. Livewire's default van 10:
                                     // een RichEditor-veld ("answer") binnenin een Repeater ("items") binnenin de
                                     // pagina-sectie-builder ("sections") slaat zijn waarde op als geneste Tiptap-JSON
                                     // (content.N.content.M...), wat de standaardlimiet al bij één FAQ-antwoord overschrijdt.
