...
class CreateCase extends Tool
{
    ...
    public function schema(JsonSchema $schema): array
    {
        return [
            ...
            'meta_title' => $schema->string()->description('SEO meta-titel (ideaal ~60 tekens).')->max(255),
            'meta_description' => $schema->string()->description('SEO meta-omschrijving (ideaal ~160 tekens).')->max(1000),
